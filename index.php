...
$page_cache=$Fox_Cache->Page_Cache("start",$cache_name,$cache_time,"false","get");
...
/*Stop cache.*/
$Fox_Cache->Page_Cache("fin",$cache_name,$cache_time,"false","post");
}
